...
Скачайте файл **Legday-macOS-1.0.0.zip** (в блоке Assets релиза). Не путайте с «Source code (zip)» — там исходники проекта, а не приложение. В Legday-macOS-1.0.0.zip лежит только **Legday.app**. Распакуйте архив и перетащите Legday.app в «Программы».
...
### Иконка в меню и таймер

В трее отображаются иконка приложения и время до следующего напоминания.

![Иконка в меню и таймер](screenshots/menu-bar.png)
